...
import gcc.holywater.velha.databinding.ActivityModoDificilBinding
import kotlin.random.Random

class Modo_Dificil : AppCompatActivity(){
    private lateinit var binding:Modo_Dificil
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            binding = ActivityModoDificilBinding.inflate(layoutInflater)
            ...
            fun buttonClick(view: View) {
                ...
                when(buttonSelecionado.id){
                    ...
                    binding.button.id -> tabuleiro[2][2] = jogadorAtual
                }
                ...
                when(posicao){
                    ...
                    9 -> {
                        binding.buttonNove.setBackgroundColor(Color.RED)
                        binding.buttonNove.isEnabled = false
                    }
                    10 -> {
                        binding.buttonDez.setBackgroundColor(Color.RED)
                        binding.buttonDez.isEnabled = false
                    }
                    11 -> {
                        binding.buttonOnze.setBackgroundColor(Color.RED)
                        binding.buttonOnze.isEnabled = false
                    }
                    12 -> {
                        binding.buttonDoze.setBackgroundColor(Color.RED)
                        binding.buttonDoze.isEnabled = false
                    }
                    13 -> {
                        binding.buttonTreze.setBackgroundColor(Color.RED)
                        binding.buttonTreze.isEnabled = false
                    }
                    14 -> {
                        binding.buttonQuatorze.setBackgroundColor(Color.RED)
                        binding.buttonQuatorze.isEnabled = false
                    }
                    15 -> {
                        binding.buttonQuinze.setBackgroundColor(Color.RED)
                        binding.buttonQuinze.isEnabled = false
                    }
                }
